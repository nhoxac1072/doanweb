                ...
                <tbody>
                        ...
                        <?php while($row =$stm->fetch()): ?> 
                                ...
                                <tr>
                                    ...
                                    <td align="center"> <?php echo htmlspecialchars($row['fullname']) ?> </td>
                                    <td align="center"> <?php echo htmlspecialchars($row['phone_number']) ?> </td>
                                    <td align="center"> <?php echo htmlspecialchars($row['email']) ?> </td>
                                    <td align="center"> <?php echo htmlspecialchars($row['birthday']) ?> </td>
