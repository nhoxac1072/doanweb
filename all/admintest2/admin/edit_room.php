...
<?php
   ...
   if(isset($_POST['edit']))
   {
       ...
       // $temp=$_FILES['img']['tmp_name'];
        ...
        $sql= "UPDATE phong SET Tenphong='$t',price='$gia' where Maphong='$m'";
        $stm= $conn->prepare($sql);
        $stm_exec=$stm->execute();
        $_GET['maphong']=$m;
        $_GET['tenphong']=$t;
        $_GET['gia']=$gia;
       // $_GET['img'];
    ...
    -->
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                ...
                <form class="container-fluid" method="post" action="./edit_room.php">
                  <label for="">hình ảnh </label>
                  <input type="file" name="img" id="" class="form-control" placeholder="" value="">
                  <label for="">mã phòng :</label>
                  <input type="text" name="maphong" id="" class="form-control" placeholder="" value="<?php echo $_GET['maphong']?>">
                  <label for="">tên phòng :</label>
                  <input type="text" name="tenphong" id="" class="form-control" placeholder="" value="<?php echo $_GET['tenphong'] ?>">
                  <label for="">giá :</label>
                  <input type="text" name="gia" id="" class="form-control" placeholder="" value="<?php echo $_GET['gia'] ?>">
