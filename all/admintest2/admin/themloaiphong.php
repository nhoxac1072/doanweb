...
if(isset($_POST['them']))
{
	...
	$sql="insert into loaiphong value(?,?)";
	$stm=$conn->prepare($sql);
	$stm->execute([$maloai,$tenloai]);
}
    ...
    -->
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                ...
                <form class="container-fluid" method="post" action="themloaiphong.php">
                  <label for="">Mã loại phòng: </label>
                  <input type="text" name="maloai" id="" class="form-control" placeholder="" value="">
                  <label for="">Tên phòng : </label>
                  <input type="text" name="tenloai" id="" class="form-control" placeholder="" value="">
